...
inline auto setup_window() -> void {
	...
	MyWnd = CreateWindowExA(0, wClass.lpszClassName, E("FirezRVG"), WS_POPUP | WS_VISIBLE, GameRect.left - 2.f, GameRect.top - 2.f, globals::width + 2.f, globals::height + 2.f, 0, 0, 0, 0);
